...
![KART 메인 화면](./assets/kart-home.jpg)
...
<table>
  <tr>
    <td width="50%">
      <img src="./assets/ui/news-list.jpg" alt="감성, 중요도, 이벤트별로 분류된 KART 뉴스 목록" width="100%">
      <br><sub><b>뉴스 탐색</b> · 감성·중요도·이벤트 필터와 관심종목 기반 피드</sub>
    </td>
    <td width="50%">
      <img src="./assets/ui/news-detail-ai-insight.jpg" alt="What Why Impact로 요약된 KART 뉴스 상세" width="100%">
...
<table>
  <tr>
    <td width="50%">
      <img src="./assets/ui/disclosure-list.jpg" alt="기간과 유형별 검색을 제공하는 KART DART 공시 화면" width="100%">
      <br><sub><b>공시 탐색</b> · 기간·유형·종목·정정 여부를 조합한 검색</sub>
    </td>
    <td width="50%">
      <img src="./assets/ui/disclosure-detail-ai-insight.jpg" alt="영문 번역과 AI 요약을 제공하는 KART 공시 상세" width="100%">
...
<table>
  <tr>
    <td width="50%">
      <img src="./assets/ui/stock-analysis.jpg" alt="원화와 달러 시세 및 거래 정보를 제공하는 KART 종목 상세" width="100%">
      <br><sub><b>종목 상세</b> · KRW/USD 시세, OHLCV, 차트와 거래 상태</sub>
    </td>
    <td width="50%">
      <img src="./assets/ui/global-peer-matching.jpg" alt="삼성전자의 글로벌 유사 기업을 분석한 KART 화면" width="100%">
      <br><sub><b>글로벌 유사기업 매칭</b> · 사업 영역별 대표 피어와 선정 근거</sub>
    </td>
  </tr>
</table>

![법정 외국인 취득 한도 지정 종목 모니터링](./assets/ui/foreign-ownership-limits.jpg)
...
<table>
  <tr>
    <td width="50%">
      <img src="./assets/ui/price-limit-alert.png" alt="상한가 또는 하한가 도달 시 나타나는 일일 가격 제한 알림" width="100%">
      <br><sub><b>상·하한가 알림</b> · 주문 지연 가능성을 종목 진입 즉시 안내</sub>
    </td>
    <td width="50%">
      <img src="./assets/ui/vi-alert.png" alt="변동성 완화장치가 발동했을 때 나타나는 VI 알림" width="100%">
...
<table>
  <tr>
    <td width="50%">
      <img src="./assets/ui/tax-agent-start.jpg" alt="거주 국가와 투자자 유형을 선택하는 KART 세무 K-Agent" width="100%">
      <br><sub><b>조세조약 확인</b> · 거주 국가와 개인·법인 유형 선택</sub>
    </td>
    <td width="50%">
      <img src="./assets/ui/tax-agent-rate-guide.jpg" alt="국내 기본세율과 조세조약 세율을 비교하는 KART 세무 K-Agent" width="100%">
...
![KART 전체 기술 구조](./assets/system-architecture.png)
